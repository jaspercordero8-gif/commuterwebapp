// Google Maps Places autocomplete
    ...
    function goToApp() {
      ...
      var energy = document.getElementById('energyLevel') ? document.getElementById('energyLevel').value : 'normal';
      ...
      errEl.textContent = '';
      var p = new URLSearchParams({ from: from, to: to, energy: energy });
